...
ALTER TYPE public.account_type OWNER TO bower36962;
...
CREATE TABLE public.review (
    ...
    CONSTRAINT fk_inv FOREIGN KEY (inv_id) REFERENCES public.inventory (inv_id) MATCH SIMPLE ON UPDATE CASCADE ON DELETE NO ACTION,
...
-- Insert a row for review (There must be a user of account_id: 2 to execute!)
-- INSERT INTO public.review (review_text, inv_id, account_id)
-- VALUES ('Da na na na na BATMAN!!!', 2, 2);